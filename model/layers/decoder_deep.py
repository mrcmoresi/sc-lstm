...
#			self.rnn = nn.LSTM(input_size, hidden_size, 1, dropout=dropout, batch_first=True)
...
#						dis, cur_hidden, cur_cell, cur_dt = self.rnn_step(last_word_dis, last_hidden, last_cell, last_dt, gen=True)
						...
						for cand_idx in range(beam_size):
							cand_word = dataset.index2word[vocab_idx[cand_idx]]
